  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-5 px-1 py-4 text-slate-950 dark:text-slate-50 sm:px-2 lg:py-8">
      <div className="animate-[ap3kDashboardRise_0.4s_ease-out_both]">
        ...
        <p className="mt-1.5 text-sm text-slate-500 dark:text-slate-400">Manage appearance, sign-in, security, and account controls.</p>
      </div>
      ...
      <section className="animate-[ap3kDashboardRise_0.6s_ease-out_both] rounded-2xl border border-red-200 bg-red-50/80 p-5 dark:border-red-500/25 dark:bg-red-500/[0.07] sm:p-6">
...
function SettingsSection({ icon, label, children }: { icon: ReactNode; label: string; children: ReactNode }) {
  return (
    <section className="ap3k-card animate-[ap3kDashboardRise_0.5s_ease-out_both] rounded-2xl p-5 transition-all duration-300 hover:-translate-y-0.5 sm:p-6">
