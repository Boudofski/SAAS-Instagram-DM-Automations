  ...
  return (
    <div className="text-center">
      ...
      <h1 className="text-2xl font-black tracking-tight mb-3">
        Instagram connected — one step left
      </h1>
      <p className="mb-10 text-slate-600 dark:text-rf-muted">
        Your connection and webhooks are ready. Create and activate an automation before testing a comment or DM.
      </p>
      ...
      >
        Create and activate my first campaign
      </Link>
