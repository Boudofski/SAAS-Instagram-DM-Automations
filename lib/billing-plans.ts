...
export const PLAN_CARDS: PlanCard[] = [
  {
    id: "FREE",
    name: "Free",
    description: "Build and test your first Instagram comment automation.",
    monthlyPrice: 0,
    annualPrice: 0,
...
export const PLAN_COMPARISON = [
  ...
  { feature: "Campaigns", pro: "Unlimited", business: "Unlimited" },
  ...
  { feature: "Campaign analytics", pro: "Included", business: "Included" },
