...
export const PLAN_CARDS: PlanCard[] = [
  {
    id: "FREE",
    name: "Free",
    description: "Connect Instagram and test the complete saved-reply flow with 50 replies for 14 days.",
    monthlyPrice: 0,
    annualPrice: 0,
    ...
    features: [
      ...
      "50 replies during your 14-day launch trial",
...
export const PLAN_COMPARISON = [
  ...
  { feature: "AI comment protection", pro: "Included", business: "Included" },
