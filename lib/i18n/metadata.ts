...
export const SITE_METADATA: Record<Locale, { title: string; description: string }> = {
  ...
  es: {
    ...
    description: "Responde automáticamente a comentarios de Instagram, envía el enlace prometido por DM y registra cada contacto, sin flujos complejos ni código.",
  },
  de: {
    title: "AP3K — Automatisierung für Instagram-Kommentare und DMs",
    description: "Beantworte Instagram-Kommentare automatisch, sende den versprochenen Link per DM und erfasse jeden Lead – ohne komplizierte Abläufe oder Code.",
  },
  pt: {
    title: "AP3K — Automação de comentários e DMs do Instagram",
    description: "Responda automaticamente a comentários do Instagram, envie o link prometido por DM e acompanhe cada contacto, sem fluxos complexos nem código.",
  },
};
