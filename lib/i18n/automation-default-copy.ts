...
export const AUTOMATION_DEFAULT_COPY: Partial<Record<Locale, Record<string, string>>> = {
  "fr": {
    ...
    "Send me the link": "Recevoir le lien",
    "Following": "Je suis abonné(e)",
    "Thanks for reaching out! Here's what you asked for ✨": "Merci pour votre message ! Voici ce que vous avez demandé ✨",
  ...
  "es": {
    ...
    "Here's the link I promised! 🎁": "¡Aquí tienes el enlace prometido! 🎁",
    "Get the Link": "Obtener el enlace",
    "Send me the link": "Envíame el enlace",
    "Following": "Ya te sigo",
    "Thanks for reaching out! Here's what you asked for ✨": "¡Gracias por escribir! Aquí tienes lo que pediste ✨",
    "Hey there! I’m so happy you’re here, thanks so much for your interest 😊 Click below and I’ll send you the link in just a sec ✨": "¡Hola! Me alegra que estés aquí, muchas gracias por tu interés 😊\n\nHaz clic abajo y te enviaré el enlace enseguida ✨",
  ...
  "de": {
    ...
    "Here's the link I promised! 🎁": "Hier ist der versprochene Link! 🎁",
    "Get the Link": "Link öffnen",
    "Send me the link": "Link erhalten",
    "Following": "Ich folge dir",
    "Thanks for reaching out! Here's what you asked for ✨": "Danke für deine Nachricht! Hier ist, was du angefragt hast ✨",
    "Hey there! I’m so happy you’re here, thanks so much for your interest 😊 Click below and I’ll send you the link in just a sec ✨": "Hallo! Schön, dass du da bist. Vielen Dank für dein Interesse 😊\n\nKlicke unten und ich schicke dir den Link sofort ✨",
  ...
  "pt": {
    ...
    "Here's the link I promised! 🎁": "Aqui está o link prometido! 🎁",
    "Get the Link": "Obter o link",
    "Send me the link": "Enviar-me o link",
    "Following": "Já sigo",
    "Thanks for reaching out! Here's what you asked for ✨": "Obrigado pela mensagem! Aqui está o que pediu ✨",
    "Hey there! I’m so happy you’re here, thanks so much for your interest 😊 Click below and I’ll send you the link in just a sec ✨": "Olá! Que bom ter a sua companhia. Muito obrigado pelo interesse 😊\n\nClique abaixo e envio-lhe o link num instante ✨",
    "Nearly there! The link is especially for my followers ✨ Right after you follow me, I’ll send you the link so you can dive straight in! 🎉": "Está quase! Este link é exclusivo para os meus seguidores ✨\n\nSiga a minha conta e confirme abaixo para receber o link! 🎉"
  }
};
