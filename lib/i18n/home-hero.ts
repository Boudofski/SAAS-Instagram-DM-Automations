...
export const HOME_HERO_COPY: Record<Locale, HomeHeroCopy> = {
  en: {
    ...
    titleTop: "Turn Instagram comments",
    titleBottom: "into conversations.",
    description: "Automatically reply to comments, DMs, and story replies. Send the right link while your audience is ready to act.",
    cta: "GET STARTED",
    secondary: "See how it works",
    allowance: "500 automated actions every month. No credit card required.",
    audience: "Built for creators, coaches & brands",
  ...
  fr: {
    ...
    titleTop: "Transformez vos commentaires Instagram",
    titleBottom: "en conversations.",
    description: "Répondez automatiquement aux commentaires, aux messages privés et aux réponses aux stories. Envoyez le bon lien au moment où votre audience est prête à agir.",
    cta: "COMMENCER",
    secondary: "Voir comment ça marche",
    allowance: "500 actions automatisées chaque mois. Sans carte bancaire.",
    audience: "Pensé pour les créateurs, les coachs et les marques",
  ...
  es: {
    ...
    titleTop: "Convierte tus comentarios de Instagram",
    titleBottom: "en conversaciones.",
    description: "Responde automáticamente a comentarios, mensajes directos y respuestas a historias. Envía el enlace adecuado cuando tu audiencia esté lista para actuar.",
    cta: "EMPEZAR",
    secondary: "Descubre cómo funciona",
    allowance: "500 acciones automatizadas al mes. Sin tarjeta de crédito.",
    audience: "Para creadores, coaches y marcas",
  ...
  de: {
    ...
    titleTop: "Mach aus Instagram-Kommentaren",
    titleBottom: "echte Gespräche.",
    description: "Beantworte Kommentare, Direktnachrichten und Story-Antworten automatisch. Sende den passenden Link, wenn deine Zielgruppe bereit ist, aktiv zu werden.",
    cta: "JETZT STARTEN",
    secondary: "So funktioniert’s",
    allowance: "500 automatisierte Aktionen pro Monat. Keine Kreditkarte erforderlich.",
    audience: "Für Creator, Coaches und Marken",
  ...
  pt: {
    ...
    titleTop: "Transforme comentários do Instagram",
    titleBottom: "em conversas.",
    description: "Responda automaticamente a comentários, mensagens diretas e respostas a stories. Envie o link certo quando o seu público estiver pronto para agir.",
    cta: "COMEÇAR",
    secondary: "Veja como funciona",
    allowance: "500 ações automatizadas por mês. Sem cartão de crédito.",
    audience: "Para criadores, coaches e marcas",
