...
function NavBar({ slug }: Props) {
  ...
  return (
      <div className="sticky top-3 z-30 flex flex-wrap items-center gap-2 rounded-2xl border border-slate-200 bg-white/95 p-2 text-slate-950 shadow-sm backdrop-blur-xl  dark:border-white/10 dark:bg-[#0B1020]/95 dark:text-slate-50 sm:flex-nowrap lg:justify-end">
