        ...
        {WORKFLOW_STEPS.map(({ step, icon: Icon, title, copy }, index) => {
          ...
          return (
            <motion.button
              ...
              className={`group relative h-full overflow-hidden rounded-[1.7rem] border bg-white/90 p-6 text-left shadow-[0_16px_45px_rgba(42,27,78,0.07)] backdrop-blur-sm transition-[border-color,box-shadow,transform] duration-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-violet-500 dark:bg-[linear-gradient(145deg,rgba(255,255,255,0.075),rgba(255,255,255,0.035))] ${isActive ? "-translate-y-1 border-violet-400 shadow-[0_22px_55px_rgba(109,40,217,0.16)] dark:border-violet-300/45" : "border-slate-200/90 hover:-translate-y-1 hover:border-violet-300 dark:border-violet-300/[0.14] dark:hover:border-violet-300/30"}`}
            >
