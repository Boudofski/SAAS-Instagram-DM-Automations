...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden ap3k-menu max-w-[calc(100vw-1.5rem)] rounded-xl border bg-popover p-1 text-popover-foreground shadow-overlay duration-fast ease-ui-out",
